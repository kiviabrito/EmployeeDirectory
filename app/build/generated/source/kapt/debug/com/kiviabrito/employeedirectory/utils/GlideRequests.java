...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.kiviabrito.employeedirectory.utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.kiviabrito.employeedirectory.utils.GlideOptions().apply(toSet));
    }
  }
}
